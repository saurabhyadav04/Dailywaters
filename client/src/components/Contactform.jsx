...
function Contactform() {
  return (
    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-10">
        <div class="mb-4">
                    ...
                    <form id="contactForm">
                        <div class="mb-6">
                            <div class="mx-0 mb-1 sm:mb-4">
                              ...
                              <div class="mx-0 mb-1 sm:mb-4">
                                    <input  type="tel"  id="phone"  name="phone" autocomplete="tel"  placeholder="Mobile Number"  class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0" />
                                </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="w-full bg-primary hover:bg-primary-dull text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
